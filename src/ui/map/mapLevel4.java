...
public class mapLevel4 extends javax.swing.JPanel {
    ...
    public mapLevel4(mainFrame mainFrame) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/images/fightbg/LEVEL 4(1).png"))); // NOI18N
    ...
    private void btnFighttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFighttActionPerformed
        ...
        String message3 = "Hahahaha, tentu saja";
        String message4 = "Aku datang untuk melawanmu";
        ...
        if (this.mainFrame != null) {
            ...
            Monster fightMonster = new Monster("Shadow Weaver", 100, 22, 5);
