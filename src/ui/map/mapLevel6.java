...
public class mapLevel6 extends javax.swing.JPanel {
    ...
    public mapLevel6(mainFrame mainFrame) {
        ...
        this.monster = new Monster("Wyvern", 160, 20, 12);
    ...
    private void btnFighttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFighttActionPerformed
        ...
        String message = "Kamu memasuki level 6. Di hadapanmu muncul boss besar. Siap untuk bertarung?";

        // Ask for confirmation to start the fight
        int confirm = JOptionPane.showConfirmDialog(this, message, "Encounter - Level 6", JOptionPane.YES_NO_OPTION);
        ...
        if (this.mainFrame != null) {
            ...
            ui.fight.FightLevel6 fightPanel = new ui.fight.FightLevel6(this.mainFrame, this.player, fightMonster);
