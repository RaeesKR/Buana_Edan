...
public class FightLevel2 extends javax.swing.JPanel {
     ...
     */
    public FightLevel2(mainFrame mainFrame, Player player, Monster monster) {
    ...
    private void initComponents() {
        ...
        bgBos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/images/fightbg/LEVEL 2(1).png"))); // NOI18N
        ...
        if (!player.isAlive() || !monster.isAlive()) {
            ...
            if (player.isAlive()) {
                ...
                if (stage == 1) {
                    ...
                    if (mainFrame != null) {
                        if (player != null) player.unlockLevel(3);
                        JOptionPane.showMessageDialog(this, "Selamat! Level 3 terbuka.");
                        mainFrame.showPanel(new ui.map.mapPanel(mainFrame));
                    }
                }
            }
