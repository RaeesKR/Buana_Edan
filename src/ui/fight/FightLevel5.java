...
public class FightLevel5 extends javax.swing.JPanel {
     ...
     */
    public FightLevel5(mainFrame mainFrame, Player player, Monster monster) {
    ...
    private void initComponents() {
        ...
        bgKroco.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/images/fightbg/LEVEL 5 KROCO 1.png"))); // NOI18N
        add(bgKroco, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        bgBos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/images/fightbg/LEVEL 5(1).png"))); // NOI18N
        ...
        if (!player.isAlive() || !monster.isAlive()) {
            ...
            if (player.isAlive()) {
                ...
                if (stage == 1) {
                    stage = 2;
                    finished = false;
                    monster = new Monster("Boss Level 5", 200, 24, 16);
