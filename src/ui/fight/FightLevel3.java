...
public class FightLevel3 extends javax.swing.JPanel {
     ...
     */
    public FightLevel3(mainFrame mainFrame, Player player, Monster monster) {
    ...
    private void performPlayerAction(boolean attack) {
        ...
        if (!player.isAlive() || !monster.isAlive()) {
            ...
            if (player.isAlive()) {
                ...
                // player lost
                player.setMaxHp(100);                // reapply armor bonus if player has armor equipped
    ...
    private void applyDamageToPlayer(int dmg) {
        ...
        // armor/defense removed; apply damage directly to HP
